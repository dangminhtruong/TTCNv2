<?php
    ...
    $sql2 = "SELECT* FROM sanpham WHERE maLoaiSP = 2";
        ...
        <div class="container-fluid" id="cayAnQua">
          <div class="row">
            ...
            <!--------------------------------------------------------------->
              ...
              <button type="button" hidden id="loaiSanPham" <?php echo "value=2"; ?>></button>
              <div id="loadSapXep">
                <?php
                $sql1 = "SELECT* FROM sanpham WHERE maLoaiSP = 2 LIMIT $maxResult OFFSET $indexRows";
